...
class nacionalidad {
		...
		public function __construct($P_id_nacionalidad,$P_nombre_nacionalidad,$P_estado_habilitado)
		{
...
class GestionarNacionalidad {
	...
	public function __construct($p_Idnacionalidad=0)
	  {
		$this->p_Idnacionalidad = $p_Idnacionalidad; 
		$this->table 	= "nacionalidad"; //TABLA
		$this->Cllave1 	= "id_nacionalidad"; //CAMPO LLAVE
		$this->conexion = Conexion::getInstance();
	  }
	...
	public function eliminar()
	  {
		...
		mysql_real_escape_string($this->p_Idnacionalidad ));
		$this->stmt = $this->conexion->ejecutar($this->query);
				if($this->stmt)	
				
				{
					$this->limpiar();
					echo $this->p_Idnacionalidad;
	...
	public function consultar()
	  {
	  	...
	  	$this->query = sprintf("SELECT id_nacionalidad FROM pruebita.nacionalidad WHERE id_nacionalidad = '%s'",
		mysql_real_escape_string($this->p_IdNacionalidad));
